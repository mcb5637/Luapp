...
namespace lua::v51 {
	...
	public:
		...
		struct Capabilities {
			static constexpr bool NativeIntegers = false, UpvalueId = false, GlobalsIndex = true, MetatableLengthModulo = true, Uservalues = false, CloseSlots = false, LoadedTable = false;
		};
