...
namespace lua::v52 {
	...
	public:
		...
		struct Capabilities {
			static constexpr bool NativeIntegers = false, UpvalueId = true, GlobalsIndex = false, MetatableLengthModulo = true, Uservalues = false, CloseSlots = false, LoadedTable = true, JIT = false;
		};
