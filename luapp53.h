...
namespace lua::v53 {
	...
	public:
		...
		struct Capabilities {
			static constexpr bool NativeIntegers = true, UpvalueId = true, GlobalsIndex = false, MetatableLengthModulo = true, Uservalues = false, CloseSlots = false, LoadedTable = true;
		};
